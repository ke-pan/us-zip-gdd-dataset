...
test('published public record is complete, sanitized, and pinned to the verified 2026-07-16 sample', async () => {
  const result = await verifyPublicRecord(repositoryRoot, { mode: 'final' });
